<html>
	<head>
		...
		<style type="text/css">
			...
			body.form form > div.main:last-of-type > input {
			        border-radius: 5px;
				    font-size: 20px;
				    height: 40px;
				    background-color: #f6b606;
		...
		<div class="main">
			...
			<div class="main">
				<form method="POST" action="{{ route('update', $user->id) }}" > 
					...
					<div class="main"><label>Nickname:</label><input name="nickname" type="text" value="{{ $user->nickname }} " required></div>
					
					<div class="main"><label>Nombres:</label><input name="nombres" type="text" value="{{ $user->nombres }}" required></div>
					
					<div class="main"><label>Apellidos:</label><input name="apellidos" type="text" value="{{ $user->apellidos }}" required></div>
					<div class="main"><label>Email:</label><input name="email" type="text" value="{{ $user->email }}" required></div>
					
					<div class="main"><label>Password:</label><input name="password" type="password" placeholder="Password" required></div>
